...
module.exports = {
    user          : process.env.NODE_ORACLEDB_USER || "dtlark",
    ...
    // needed.
    password      : process.env.NODE_ORACLEDB_PASSWORD || "Databases2099",
  
    // For information on connection strings see:
    // https://oracle.github.io/node-oracledb/doc/api.html#connectionstrings
    connectString : process.env.NODE_ORACLEDB_CONNECTIONSTRING || "oracle.cise.ufl.edu:1521/orcl",
